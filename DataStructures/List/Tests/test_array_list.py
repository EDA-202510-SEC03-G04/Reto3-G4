...
def test_get_last_element():
    ...
    assert lt.last_element(lista) is not None   #función estaba programada para correr con firts element, la corregí para que tuviera sentido con el contexto y last element 
